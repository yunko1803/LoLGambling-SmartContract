...
contract GambleFactory {
    Gamble[] public deployedGambles;

    function createGamble(uint256 gameId) public {
        Gamble newGamble = new Gamble(gameId);
        deployedGambles.push(newGamble);
    }

    function getDeployedGambles() public view returns (Gamble[] memory) {
        return deployedGambles;
    }
}
